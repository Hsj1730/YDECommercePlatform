 ...
 * @author : Hsj1730
 * @version : 1.0
 * @date : Created in 2022/03/29 20:12
 * @description :
 */

public interface MaterialService {

    PageInfo<MaterialDto> getMaterialList(Map<String,Object> param);

    Result uploadMaterial(MultipartFile file);

    void addMaterial(Material material);

    void deleteMaterial(MaterialDto dto);
